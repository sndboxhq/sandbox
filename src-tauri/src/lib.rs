...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::save_collaboration_bootstrap,
            ...
            commands::start_workflow_collaboration,
            commands::join_workflow_collaboration,
            commands::append_workflow_collaboration_operation,
            commands::poll_workflow_collaboration_operations,
            commands::update_workflow_collaboration_presence,
            commands::list_workflow_collaboration_presence,
            commands::leave_workflow_collaboration,
            ...
            commands::prepare_workflow_collaboration_snapshot,
