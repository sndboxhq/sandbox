...
- Publication requires the protected GitHub release environment and the immutable `v8.0.0-beta.1` tag. This invite-only prerelease may publish an unsigned Windows installer with checksums and attestations.
