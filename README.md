...
- Publication requires the protected GitHub release environment and the immutable `v0.8.0-beta.1` tag. This invite-only prerelease may publish an unsigned Windows installer with checksums and attestations.
