...
- Publication requires the protected GitHub release environment and the immutable `v0.7.10-beta.2` tag. This invite-only prerelease may publish an unsigned Windows installer with checksums and attestations.
