...
let runners=[
  {runnerId:"33333333-3333-4333-8333-333333333333",displayName:"Production EU-1",workspaceId,operatingSystem:"linux",architecture:"x86_64",applicationVersion:"0.8.0-beta.1",protocolVersion:1,status:"online",currentWorkload:2,tags:["production","eu-west"],pairedAt:now,lastSeenAt:now},
  {runnerId:"44444444-4444-4444-8444-444444444444",displayName:"Backup ARM",workspaceId,operatingSystem:"linux",architecture:"aarch64",applicationVersion:"0.8.0-beta.1",protocolVersion:1,status:"offline",currentWorkload:0,tags:["backup"],pairedAt:now,lastSeenAt:null}
];
